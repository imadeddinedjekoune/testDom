...
export function PlayersTable({ gameState, onDeclareWinner }: PlayersTableProps) {
              ...
              <tr key={player.id} className="hover:bg-gray-50">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <div className={`h-8 w-8 ${getPlayerColor(player.position)} rounded-full flex items-center justify-center text-white font-medium text-sm`}>
                      P{player.position}
                    </div>
                    <div className="ml-3">
